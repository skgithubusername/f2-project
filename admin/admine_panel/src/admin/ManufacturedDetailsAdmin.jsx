...
//         try {
//             const response = await axios.get('/api/manufactureDetails/allManufactureDetails');
...
//         try {
//             await axios.delete(`/api/manufactureDetails/${detail.id}`);
...
//             const url = `/api/manufactureDetails/${detailToUpdate.id}`;
...
//             try {
//                 const response = await axios.post('/api/manufactureDetails/addManufactureDetail', formData, {
//                     headers: {
//                         'Content-Type': 'multipart/form-data'
//                     }
//                 });
...
//             <h1 className="text-2xl font-bold mb-4">Manufacture Detail Management</h1>
//             <div className="mb-4">
//                 <input
//                     type="text"
//                     placeholder="Title"
...
const ManufacturedDetailsAdmin = () => {
    const [title, setTitle] = useState('');
    const [desc, setDesc] = useState('');
    const [currentIndex, setCurrentIndex] = useState(null);
    const [selectedFile, setSelectedFile] = useState(null);
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-2xl font-bold mb-4">Manufacture Details</h1>
            <div className="mb-4">
                <input
                    type="text"
                    placeholder="Title"
...
export default ManufacturedDetailsAdmin;
